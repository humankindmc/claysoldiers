...
public record ClaySoldierSettings(
        ...
        boolean pathfindingPlannerEnabled,
        int pathfindingMaxNodes,
        double pathfindingMaxRange,
        int pathfindingSearchMargin,
        int pathfindingRouteRefreshTicks,
        double pathfindingRouteTargetMoveThreshold,
        double pathfindingWaypointReachDistance,
        boolean pathfindingAllowDiagonal,
        boolean pathfindingAvoidCornerCutting,
        double pathfindingMaxDropHeight,
        double pathfindingHeuristicWeight,
        double pathfindingVerticalPenalty,
        boolean pathfindingSmoothRoutes,
        boolean pathfindingAvoidHazards,
        double pathfindingHazardPenalty,
    ...
    public static ClaySoldierSettings from(FileConfiguration config) {
        ...
        return new ClaySoldierSettings(
                ...
                config.getBoolean(base + "movement.pathfinding-planner-enabled", true),
                clamp(config.getInt(base + "movement.pathfinding-max-nodes", 750), 32, 10_000),
                config.getDouble(base + "movement.pathfinding-max-range", 24.0D),
                clamp(config.getInt(base + "movement.pathfinding-search-margin", 8), 1, 64),
                clamp(config.getInt(base + "movement.pathfinding-route-refresh-ticks", 12), 1, 200),
                config.getDouble(base + "movement.pathfinding-route-target-move-threshold", 1.15D),
                config.getDouble(base + "movement.pathfinding-waypoint-reach-distance", 0.34D),
                config.getBoolean(base + "movement.pathfinding-allow-diagonal", true),
                config.getBoolean(base + "movement.pathfinding-avoid-corner-cutting", true),
                config.getDouble(base + "movement.pathfinding-max-drop-height", 1.0D),
                config.getDouble(base + "movement.pathfinding-heuristic-weight", 1.0D),
                config.getDouble(base + "movement.pathfinding-vertical-penalty", 0.35D),
                config.getBoolean(base + "movement.pathfinding-smooth-routes", true),
                config.getBoolean(base + "movement.pathfinding-avoid-hazards", true),
                config.getDouble(base + "movement.pathfinding-hazard-penalty", 6.0D),
